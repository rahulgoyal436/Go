...
class TestAuthentication:
    ...
    @pytest.mark.parametrize("endpoint", ["/pet","/pet/findByStatus","/pet/findByTags","/pet/123","/pet/123/uploadImage","/store/inventory","/store/order","/store/order/123","/user","/user/createWithList","/user/login","/user/logout","/user/testuser"])
