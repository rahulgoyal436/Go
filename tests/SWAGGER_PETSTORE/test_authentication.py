...
class TestAuthentication:
    ...
    @pytest.mark.parametrize("endpoint", ["/pet","/pet/findByStatus","/pet/findByTags","/pet/test","/pet/test/uploadImage","/store/inventory","/store/order","/store/order/test","/user","/user/createWithArray","/user/createWithList","/user/login","/user/logout","/user/test"])
